/**************************************************************************************************
  Filename:       ZDApp.h
  Revised:        $Date: 2013-10-11 17:01:59 -0700 (Fri, 11 Oct 2013) $
  Revision:       $Revision: 35655 $
...
#endif
#define ZDO_CONTINUE_ASSOC        0x2000
...
#define NUM_DISC_ATTEMPTS           ZDO_NUM_DISC_ATTEMPTS //2
#endif

#if !defined NUM_RE_ASSOC_TIMES
#define NUM_RE_ASSOC_TIMES          ZDO_NUM_RE_ASSOC_TIMES //2
#endif
...
#ifndef ZCD_NV_BLACK_LIST
  #define ZCD_NV_BLACK_LIST                 0x0401
#endif
...
// Black List
//--------------------------------------------------------------------
#define MAX_BLACK_LIST_ITEM 10  // Maximum # of black-listed networks
#define NUM_BLACK_LIST_REC  1
#endif  // BLACK_LIST
...
{
  uint8 numItem;
  zdoBlackListItem_t item[MAX_BLACK_LIST_ITEM];
  //uint16 panid[MAX_BLACK_LIST_ITEM];
} zdoBlackList_t;
#endif
...
/*
 * ZDApp_NwkDescCount
 *   - How many scanned WPAN can be used
 */
extern uint8 ZDApp_NwkDescCount(void);

/*
 * ZDApp_SearchForParent
 *   - Search for pre-parent or rejoin new parent
 */
extern void ZDApp_SearchForParent(void);

/*
 * ZDApp_CountinueJoin
 *   - countnue join after a fail-joining
 */
extern void ZDApp_CountinueJoin(void);
/*********************************************************************
 * @fn          ZDO_SrcRtgIndCB
 *
...
#ifdef BLACK_LIST
extern uint8 ZDApp_BlackListInit(uint8 setDefault);
extern uint8 ZDApp_BlackListAdd(uint16 panid);
//extern bool ZDApp_UnauthPanCheck(uint16 panId,uint8 logicalChannel);
//extern void ZDApp_UnauthPanClear(void);

#endif

extern void ZDApp_StartNewNetwork(void);
/*********************************************************************
*********************************************************************/
